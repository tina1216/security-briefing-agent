...
def setup_telemetry() -> str | None:
    ...
    if bucket and capture_content != "false":
        ...
        os.environ.setdefault(
            ...
            f"service.namespace=security-briefing-agent,service.version={commit_sha}",
        )
    ...
    try:
        ...
        logging.warning(
            "GCP default auth keys not found or invalid. Skipping OpenTelemetry GCP exporters setup: %s",
            e,
        )
